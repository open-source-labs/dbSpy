...
let impactedTable = TableBeforeChange[tableName];
    
   let querySet = [];
   let objChangeSet = {} //ObjectSet is Set of changes to Column
   ...
   if (typeof(ColAfterChange.constraint) == "string")
   {
    if (ColAfterChange.constraint !== ColBeforeChange.constraint)
    {
        ...
        let oldConstObj = {};
        for(let constraints in objConstraints)
            {
