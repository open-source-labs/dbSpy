  ...
  return (
    <>
      <div className="max-w-2xl mx-auto">
        <aside
          className="w-64 absolute inset-y-0 left-0 top-24 featureTab"
              ...
              <li>
                ...
                >
                  <svg
                    ...
                    strokeWidth={1.5}
                    stroke="currentColor"
                    className="w-6 h-6 flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white dark:stroke-[#f8f4eb]"
                  >
                    <path
                      strokeLinecap="round"
              ...
              <li>
                ...
                >
                  <svg
                    ...
                    strokeWidth={1.5}
                    stroke="currentColor"
                    className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white dark:stroke-[#f8f4eb]"
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
        ...
        <div ref={confirmModal} id="confirmModal" className="confirmModal">
          ...
          <div className="modal-content content-center bg-[#f8f4eb] dark:bg-slate-800 rounded-md border-0 w-[30%] min-w-[300px] max-w-[550px] shadow-[0px_5px_10px_rgba(0,0,0,0.4)] dark:shadow-[0px_5px_10px_#1e293b]">
            <p className="text-center mb-4 text-slate-900 dark:text-[#f8f4eb]">
            ...
            <div className="flex justify-between w-[50%] max-w-[200px] mx-auto">
              <button
                ...
                className="text-slate-900 hover:opacity-70 dark:text-[#f8f4eb] modalButton"
              >
                Confirm
              </button>
              <button
