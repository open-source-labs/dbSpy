...
console.log(parseSql(`CREATE TABLE public.projects (
  id integer NOT NULL,
...
ALTER TABLE ONLY public.projects_skills_join_table
  ADD CONSTRAINT projects_skills_join_table_pk PRIMARY KEY (id);    
...
ALTER TABLE ONLY public.users_projects_join_table
  ADD CONSTRAINT users_projects_join_table_pk PRIMARY KEY (id); 
  
ALTER TABLE ONLY public.users_skills_join_table
  ADD CONSTRAINT users_skills_join_table_pk PRIMARY KEY (id);
