...
const postgresQuery = async (req, res, next) => {
    try {
        ...
        async function postgresFormatTableSchema(columns, tableName) {
            const tableSchema = {};
            for (const column of columns) {
                ...
                const foreignKey = await foreignKeys.find((fk) => fk.foreign_key_column === columnName);
