...
const oracleController = {
    ...
    oracleQuery: async (req, res, next) => {
        ...
        async function oracleFormatTableSchema(oracleSchema, tableName) {
            const tableSchema = {};
        ...
        try {
            ...
            for (const table of tables) {
                ...
                const oracleSchema = await OracleDataSource.query(oracle_queries_1.oracleSchemaQuery.replace('user', user.toUpperCase()).replace('tableName', tableName));
