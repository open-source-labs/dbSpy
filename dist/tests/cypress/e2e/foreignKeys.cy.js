...
describe('Foreign Keys', () => {
    ...
    it('adds a foreign key', () => {
        ...
        cy.get('g[data-testid=rf__edge-table_1-to-table_2]')
            ...
            cy.get('g.react-flow__edge-textwrapper').should('contain', 'column_1-to-column_1');
        });
    });
    ...
    it('adds a foreign key if user drags table, drags backdrop, and changes zoom', () => {
        ...
        cy.get(`div[data-testid=rf__node-table_1] tr#column_1 button[data-testid=edit-column]`).click();
        // zoom out 3x
...
//# sourceMappingURL=foreignKeys.cy.js.map