...
function InputModal({ mode, closeInputModal, tableNameProp, }) {
    ...
    const initialTable = 'untitled_table'; //for adding new table
    ...
    return (react_1.default.createElement("div", { id: "inputModal", className: "input-modal" },
        react_1.default.createElement("form", { autoComplete: "off", onSubmit: (e) => {
            ...
            react_1.default.createElement("div", { className: "table-name" }, mode === 'table' ? (react_1.default.createElement(react_1.default.Fragment, null,
                ...
                react_1.default.createElement("input", { id: "table-modal-name", value: tableName, required: true, maxLength: 63, onChange: (e) => setTableName((dbCredentials.db_type === 'postgres' ? e.target.value.toLowerCase().trim() : e.target.value).trim()) }))) : (react_1.default.createElement("h1", null, `Table Name: ${tableName}`))),
            react_1.default.createElement("div", { className: "column-header" },
                ...
                dbCredentials.db_type !== 'oracle' ? (react_1.default.createElement("button", { type: "button", className: "text-slate-900 dark:text-[#f8f4eb]", onClick: addColumn, "data-testid": "add-table-add-column" }, "Add Column")) : null),
            columnInputs,
            react_1.default.createElement("div", { className: "mx-auto flex w-[50%] max-w-[200px] justify-between" },
                react_1.default.createElement("button", { type: "button", className: "modalButton text-slate-900 hover:opacity-70 dark:text-[#f8f4eb] border-slate-500", onClick: closeInputModal, "data-testid": "modal-cancel" }, "Cancel"),
