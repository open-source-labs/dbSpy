...
const yc_jpg_1 = __importDefault(require("../../assets/contributors/yc.jpg"));
...
const SH_jpg_1 = __importDefault(require("../../assets/contributors/SH.jpg"));
const joseph_360_png_1 = __importDefault(require("../../assets/contributors/joseph_360.png"));
/*
Example:
{
...
const profileList = [
    ...
    {
        imgUrl: joseph_360_png_1.default,
        name: 'Joseph Tejeda',
        title: 'Software Engineer',
...
function Contributors() {
    ...
    for (let i = profileList.length - 1; i >= 0; i--) {
        profiles.push(react_1.default.createElement(Profile_1.default, { props: profileList[i], key: `contributor${i}` }));
    }
    ;
