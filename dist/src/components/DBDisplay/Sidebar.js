...
const Sidebar = (props) => {
    ...
    const [serviceName, setServiceName] = (0, react_1.useState)('');
    ...
    return (react_1.default.createElement("form", { id: "dbconnect", className: "bg-[#fbf3de] dark:bg-slate-700" },
        ...
        react_1.default.createElement("span", { className: "form-item" },
            ...
            react_1.default.createElement("select", { className: "form-box rounded bg-[#f8f4eb] hover:shadow-sm focus:shadow-inner focus:shadow-[#eae7dd]/75 dark:hover:shadow-[#f8f4eb]", id: "db_type", name: "db_type", onChange: (e) => {
                ...
                react_1.default.createElement("option", { value: "oracle" }, "Oracle SQL (requires OIC)"),
                react_1.default.createElement("option", { value: "sqlite" }, "SQLite3"))),
        react_1.default.createElement("br", null),
        react_1.default.createElement("div", null,
            (serviceName !== 'sqlite') && (react_1.default.createElement("div", { className: "form-item" },
                react_1.default.createElement("span", { className: "flex position" },
                    ...
                    react_1.default.createElement(react_2.default, { content: infoIconStr, placement: "top", trigger: "mouseenter click" },
                        react_1.default.createElement("img", { src: informationSqIcon_png_1.default, alt: "Information Icon", className: "h-3 rounded-full ml-2" }))),
            ...
            (serviceName === 'oracle') && (react_1.default.createElement("div", null,
                react_1.default.createElement("span", { className: "form-item" },
                    react_1.default.createElement("label", { htmlFor: "service-name", className: "dark:text-[#f8f4eb]" }, "Service Name"),
                    react_1.default.createElement("input", { className: "form-box rounded bg-[#f8f4eb] hover:shadow-sm focus:shadow-inner focus:shadow-[#eae7dd]/75 dark:hover:shadow-[#f8f4eb]", type: "text", id: "service-name", name: "service-name", autoComplete: "off", placeholder: 'ORCL', value: formValues.service_name, onChange: (e) => {
                            setFormValues({ ...formValues, service_name: e.target.value });
                        } })),
                react_1.default.createElement("span", { className: "flex justify-start items-center space-x-2 mt-3" },
                    react_1.default.createElement("p", { className: "align-middle dark:text-[#f8f4eb]" }, "Default:"),
                    react_1.default.createElement("button", { className: "form-button rounded border bg-[#f8f4eb] py-2 px-4 hover:opacity-80 hover:shadow-inner dark:border-none dark:bg-slate-500 dark:text-[#f8f4eb] dark:hover:shadow-lg", onClick: (e) => {
                            e.preventDefault();
                            setFormValues({ ...formValues, service_name: 'ORCL' });
                        } }, "ORCL")))),
            (serviceName === 'sqlite') && (react_1.default.createElement("div", null,
                react_1.default.createElement("span", { className: "form-item" },
            ...
            (serviceName !== 'sqlite') && (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement("div", null,
                    react_1.default.createElement("br", null),
