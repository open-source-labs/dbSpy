...
function FeatureTab(props) {
    ...
    const { schemaStore, setSchemaStore, undoHandler, redoHandler, historyCounter } = (0, schemaStore_1.default)((state) => state);
                    ...
                    react_1.default.createElement("ul", { className: "space-y-2" },
                        ...
                        react_1.default.createElement("li", null,
                            react_1.default.createElement("a", { onClick: () => {
                                ...
                                react_1.default.createElement("span", { className: "ml-3 flex-1 whitespace-nowrap" }, "Add Table"))),
                        react_1.default.createElement("li", null,
