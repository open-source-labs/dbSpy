...
const DBDisplay = () => {
    ...
    const { sidebarDisplayState, welcome, editRefMode, inputModalState, setInputModalState, inputDataModalState, setDataInputModalState, deleteTableModalState, setDeleteTableModalState, currentTable, isSchema, setTableMode } = (0, settingsStore_1.default)((state) => state);
    ...
    return (react_1.default.createElement("div", { id: "DBDisplay", className: "bg-[#f8f4eb] transition-colors duration-500 dark:bg-slate-700" },
        ...
        inputModalState.isOpen ? (react_1.default.createElement(InputModal_1.default, { mode: inputModalState.mode, tableNameProp: currentTable, closeInputModal: () => setInputModalState(false) })) : null,
        inputDataModalState.isOpen ? (react_1.default.createElement(DataInputModal_1.default, { mode: inputModalState.mode, tableNameProp: currentTable, closeDataInputModal: () => setDataInputModalState(false) })) : null,
